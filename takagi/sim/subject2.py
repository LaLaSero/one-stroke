...
x_targets_full = np.concatenate([x_line1, x_line2, x_line3, x_line4, x_parabola, x_line5])
y_targets_full = np.concatenate([y_line1, y_line2, y_line3, y_line4, y_parabola, y_line5])
